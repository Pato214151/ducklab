...
export default function Navbar() {
  ...
  const light = ['/', '/planes', '/blog', '/contacto'].includes(pathname);
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between">
          ...
          <button
            ...
            className={`transition-colors md:hidden ${light ? 'text-[#0b0b0c] hover:text-[#db1f2e]' : 'text-gray-300 hover:text-white'}`}
            aria-label="Menú"
          >
      ...
      {/* Mobile menu */}
      <div
        className={`absolute left-0 top-20 w-full overflow-hidden border-b backdrop-blur-xl transition-all duration-300 md:hidden ${
