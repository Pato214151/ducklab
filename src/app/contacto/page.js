...
export const metadata = {
  title: 'Contacto | Ducklab',
  description: 'Hablemos de tu proyecto. Primera consulta técnica gratuita.',
};

const WHATSAPP = 'https://wa.me/573203182862'; // ← reemplaza por tu número real
const EMAIL = 'jramirezramirez2005@gmail.com';

const channels = [
  { Icon: MessageCircle, title: 'WhatsApp', value: 'Respuesta rápida', href: WHATSAPP, cta: 'Escribir', external: true },
  { Icon: Mail, title: 'Correo', value: EMAIL, href: `mailto:${EMAIL}`, cta: 'Enviar', external: false },
  { Icon: MapPin, title: 'Ubicación', value: 'Colombia · 100% remoto', href: null, cta: null, external: false },
];
    ...
    <main className="grain bg-pearl relative min-h-screen text-[#0b0b0c] selection:bg-[#db1f2e]/20">
      ...
      <section className="relative overflow-hidden px-4 pt-36 pb-28 md:pt-44">
        ...
        <div className="mx-auto max-w-3xl text-center">
          <p className="mb-4 font-mono text-[11px] font-semibold uppercase tracking-[0.35em] text-[#db1f2e]">Contacto</p>
          <h1 className="text-4xl font-bold tracking-tight md:text-6xl">Hablemos de tu proyecto</h1>
          <p className="mt-6 text-lg text-[#56565d] md:text-xl">
            Cuéntame qué necesitas. La primera consulta técnica es 100% gratuita y sin compromiso.
          </p>
          ...
          <div className="mt-12">
            ...
            >
              <MessageCircle className="h-5 w-5" strokeWidth={1.75} /> Escríbeme por WhatsApp
            </a>
          </div>
        </div>
      </section>
